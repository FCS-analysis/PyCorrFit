...
\begin{tabular}{l l}
 ...
 Confocor3 (*.fcs) & AIM 4.2, ZEN 2010, Zeiss, Germany \\
 Correlator ALV6000 (*.ASC) & ALV Laser GmbH, Langen, Germany \\
 Correlator.com (*.SIN) & www.correlator.com, USA \\
 Matlab ‘Ries (*.mat) & EMBL Heidelberg, Germany \\
 PyCorrFit (*.csv) & Paul Müller, TU Dresden, Germany \\
 Zip files (*.zip) & Paul Müller, TU Dresden, Germany \\
\end{tabular}
