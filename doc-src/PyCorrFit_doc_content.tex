...
\includegraphics[width=\linewidth]{PyCorrFit_Screenshot_Main.png}
 \mycaption{user interface of PyCorrFit}{Confocal measurement of Alexa488. Note the cross-correlation... \label{fig:PyCorrFitMain}}
\end{figure}
