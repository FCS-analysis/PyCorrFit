...
\textit{PyCorrFit} supports the import of your own model functions. If your model function is not implemented, i.e. not available in the \textit{Models} menu, then this is the easiest way to make \textit{PyCorrFit} work with your model.
